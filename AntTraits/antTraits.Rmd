...
ParaNimble <- function(NChains, FUN, ...) {
  require(parallel)
  nimble_cluster <- makeCluster(4)
  
  samples <- parLapply(cl = nimble_cluster, X = 1:4, fun = FUN, ...)
...
The traceplots look good. We can now calculate variance explained for the latent variables.

- take 1/zvar and epsvar/zvar? But marginal var or not..
