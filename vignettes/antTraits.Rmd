...
In fact, if we plot B[2,1] and B[2,2] we see that the effect of the volume of lying CWD has an effect that flips between the first and second latent axes.
