...
<details><summary>The details of what we do to make this identifiable are here</details>
...
<details><summary>We need a function to generate initial values, but tis is boring</summary>
```{r init}
...
<details><summary>Functions to run the code are here. They may be overkill, but </summary>
...
<details><summary>For those who are interested, this is how we deal with the rotations</details>
