...
```{r meanvar, cache=TRUE, message=FALSE}
...
```{r results1, warning=FALSE, message=FALSE, fig.height = 30}
...
```{r ResO, warning=FALSE, message=FALSE, fig.height = 30}
...
```{r plotEnv1LV, warning=FALSE,message=FALSE, fig.height=10}
par(mar=c(4.1, 7, 1, 1))
...
```{r results2, fig.height=30}
chainsPlot(chains2LV, var = "B", legend = F, ncols = 2)
```

And the trait effects:

```{r ResO2LV, warning=FALSE,message=FALSE, fig.height=30}
